...
/**
 * FifoQueue is a first-in first-out queue with a fixed size that
 * replaces its oldest element if full.
 * <p>
 * The removal order of a {@link FifoQueue} is based on the
...
public class FifoQueue<E> extends AbstractCollection<E>
     ...
     * {@inheritDoc}
     * <p>
     * A {@code FifoQueue} can never be full, thus this returns always
     * {@code false}.
     *
